"""
Django settings for NufraWeb project.
...
SECRET_KEY = 'django-insecure-1w7+#@t$#)wy4bqbgd=mya17bwximxa#yg%ny*pm)hk$rix6(7'
...
WSGI_APPLICATION = 'NufraWeb.wsgi.application'
